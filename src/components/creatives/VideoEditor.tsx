    ...
    <Card className="h-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            placeholder="Describe how you want to enhance the video (e.g., improve lighting, add transitions, remove background noise)..."
            value={aiPrompt}
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button variant="outline" disabled={!videoFile}>
